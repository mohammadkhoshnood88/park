 ...
 *   https://datatables.net/download/#dt/dt-1.10.18/af-2.3.3/fh-3.1.4/sc-2.0.0/sl-1.3.0
 *
 * Included libraries:
 *   DataTables 1.10.18, AutoFill 2.3.3, FixedHeader 3.1.4, Scroller 2.0.0, Select 1.3.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			...
			"sEmptyTable": "هیچ گزارشی وجود ندارد",
			...
			"sInfo": "_END_ مورد از مجموع _TOTAL_ مورد نشان داده شده است",
			...
			"sLengthMenu": "تعداد نمایش داده شده : _MENU_",
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.10.18/af-2.3.3/fh-3.1.4/sc-2.0.0/sl-1.3.0",
